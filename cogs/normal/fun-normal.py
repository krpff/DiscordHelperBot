...
class Fun(commands.Cog, name="fun-normal"):
    ...
    @commands.command(name="randomfact", description="Get a random fact.")
    ...
    async def coinflip(self, context: Context) -> None:
        buttons = Choice()
        embed = disnake.Embed(description="What is your bet?", color=0x9C84EF)
    ...
    @commands.command(
        name="rps", description="Play the rock paper scissors against the bot."
    )
    @checks.not_blacklisted()
